...
export const gameIndex = sqliteTable("game_index", {
  id: integer("id").primaryKey(),
  pokemon_id: integer("pokemon_id"),
...
export const heldItem = sqliteTable("held_item", {
  id: integer("id").primaryKey(),
  pokemon_id: integer("pokemon_id"),
...
export const sprite = sqliteTable("sprite", {
  id: integer("id").primaryKey(),
  pokemon_id: integer("pokemon_id"),
...
export const pastType = sqliteTable("past_type", {
  id: integer("id").primaryKey(),
  pokemon_id: integer("pokemon_id"),
